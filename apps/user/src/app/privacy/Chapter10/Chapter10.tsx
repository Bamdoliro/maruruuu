...
const Chpater10 = () => {
  return (
    <PolicyRoule title="제10조 (권익침해 구제 방법)">
      <StyledText fontType="p3" color={color.gray900}>
        ...
        있습니다.
        <br />② 우리학교의 자체적인 개인정보 불만처리, 피해구제 결과에 만족하지 못하시거나
        보다 자세한 도움이 필요하시면 아래의 기관에 문의하시기 바랍니다.
        ...
        처분 또는 부작위로 인하여 권리 또는 이익을 침해 받은 자는 행정심판법이 정하는 바에
        따라 행정심판을 청구할 수 있습니다.
